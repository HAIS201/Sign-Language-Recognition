...
# 저장된 데이터 불러오기...
data_path = "C:/Users/2reny/Desktop/LSTM3/PadData"
# 학습 및 테스트 데이터 로딩
...
x1 = Bidirectional(LSTM(64, return_sequences=True, dropout=0.1, recurrent_dropout=0.1))(x)
x2 = Bidirectional(LSTM(32, return_sequences=True, dropout=0.1, recurrent_dropout=0.1))(x1)
x2 = Dense(128)(x2)
x = Add()([x1, x2])
